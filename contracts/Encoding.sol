...
contract Encoding {
    ...
    // for you. Flashback to when we withdrew ETH from our raffle and from our RandomIpfsNft:
    ...
    // Remember this? from the hardhat-nfts/contracts/RandomIpfsNft withdraw function?
